...
CMD cd ${INPUT_MOLECULE_WORKING_DIR}; ANSIBLE_STDOUT_CALLBACK=junit JUNIT_OUTPUT_DIR=".junit-results" JUNIT_FAIL_ON_CHANGE=true JUNIT_HIDE_TASK_ARGUMENTS=true molecule ${INPUT_MOLECULE_OPTIONS} ${INPUT_MOLECULE_COMMAND} ${INPUT_MOLECULE_ARGS}
